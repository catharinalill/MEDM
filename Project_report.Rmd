...
#Compute NB error
mean(valid_data_y != predictNBLap) #0.3848889

#Compute NB accuracy
mean(valid_data_y == predictNBLap) #0.6151111

posPredNBLap <- posPredValue(predictNBLap, valid_data_y, positive = "None") #0.6515361
...
#Compute NB error
mean(test_data_y != predictNB) #0.3904444

#Compute NB accuracy
mean(test_data_y == predictNB) #0.6095556
...
posPredTREEgini <- posPredValue(predictTREEgini, valid_data_y, positive = "None")      #Gini is better
