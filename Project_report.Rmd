...
count_delayed <-counts_delays[1]
count_nodelayed <-counts_delays[2]
...
barplot(table(group_tags_departure), main="Distribution of flights by Scheduled Departure Hour",
  xlab="Scheduled Departure Hour", col=c("darkturquoise"), width = 1, space = 0.1, beside=TRUE, height = table(group_tags_departure), xaxt = "n")
...
barplot(table(group_tags_arrival), main="Distribution of flights by Scheduled Arrival Hour",
  xlab="Scheduled Arrival Hour", col=c("darkturquoise"), width = 1, space = 0.1, beside=TRUE, height = table(group_tags_arrival), xaxt = "n")
...
barplot(table(group_tags_time), main="Distribution of flights by Scheduled Time",
  xlab="Scheduled Time (minutes)", col=c("darkturquoise"), width = 1, space = 0.1, beside=TRUE, height = table(group_tags_time), xaxt = "n")
...
#Compute NB error
mean(valid_data_y != predictNBLap) #0.3866667

#Compute NB accuracy
mean(valid_data_y == predictNBLap) #0.6133333

posPredNBLap <- posPredValue(predictNBLap, valid_data_y, positive = "None") #0.6527973
...
#Compute NB error
mean(test_data_y != predictNB) #0.3893333

#Compute NB accuracy
mean(test_data_y == predictNB) #0.6106667
...
#BACKWARD PROBLEM: FIND THE AIRLINE ------------------------------- ORGANIZE THIS
